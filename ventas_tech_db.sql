...
-- Insertando 4 registros en la tabla categorias
...
-- Insertando 5 registros en la tabla clientes
...
-- Insertando 6 registros en la tabla productos
...
-- Insertando 10 registros en la tabla ventas
...
-- Consultando tabla categorias
SELECT * FROM categorias;   -- esperado: 4 filas

-- Consultando tabla clientes
